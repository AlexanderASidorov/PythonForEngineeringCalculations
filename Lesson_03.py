...
# последовательно каждое числа из списка умножается на 2
#%%
...
# Обратите внимание, что вместе со списком ListNumbers изменился список Copy01ListNumbers.
# Это характерная особенность сложных объектов Python (списки, словари, массивы и т.д.):
